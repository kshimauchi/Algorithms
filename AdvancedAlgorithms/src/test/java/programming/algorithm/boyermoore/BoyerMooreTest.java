...
public class BoyerMooreTest {
    ...
    public void suffixLengthTest(){
        ...
        Assert.assertEquals(6, b.suffixLength("kaikai".toCharArray(), 5));
    }
    @Test
    ...
    public void searchTest(){
        Assert.assertEquals(14, b.search("thisisout firsttest".toCharArray(),"tt".toCharArray()));
        ...
        Assert.assertEquals(-1, b.search("abcdbabaidai".toCharArray(),"z".toCharArray()));

        Assert.assertEquals(0, b.search("abcdbabaidai".toCharArray(),"".toCharArray()));
